...
//     {
//         title: 'Classic',
//         src: '/themes/ex_classic.jpg'
//     },
//     {
//         title: 'Modern',
//         src: '/themes/ex_modern.jpg'
//     },
//     {
//         title: 'Minimalist',
//         src: '/themes/ex_minimalist.jpg'
//     }
// ]
    ...
    return (
        < section className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-8 relative" >
            <div className=" flex flex-col  items-center sm:items-start z-10">
                <h1 className="text-2xl flex flex-col sm:text-4xl justify-start font-bold text-left tracking-tight">
                    ...
                    <div className="flex flex-row items-center gap-4">
                        Instantly Build Your{" "}
                        <RotatingText
                            texts={['CV', 'Resume', 'Portfolio', 'Profile']}
                            mainClassName="px-2 sm:px-2 md:px-3 bg-primary text-secondary overflow-hidden min-w-50 py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                            staggerFrom={"last"}
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
                            exit={{ y: "-120%" }}
                ...
                <div className="text-xs sm:text-xl gap-2 flex flex-col pl-4 text-left font-bold handwritten max-w-2xl mb-8 mt-2 text-muted-foreground">
            ...
            <div className="hidden pt-50 overflow-y-clip items-center md:block pointer-events-none select-none relative">
                <img
            ...
            {/* <div className="overflow-y-clip h-[600px] relative">
                <CardSwap
                    cardDistance={60}
                ...
                >
                    {cardList.map((item) => (
                        <Card className=" overflow-clip min-h-[500px]">
                            <h3 className="p-2 text-secondary text-right">{item.title}</h3>
                            <img
                                src={item.src}
                                alt={item.title}
