...
export default function Header() {
    return (
        <header className={
            ...
            <div className="relative mx-auto max-w-screen-xl flex items-center justify-between px-4 md:px-8 h-32 py-4">
                <Link href="/" className="flex items-center gap-2">
                    <Image src="/primary.svg" alt="SmartCV Logo" width={96} height={96} className="dark:hidden dark:-rotate-90 scale-100 block transition-all" />
                    <Image src="/secondary.svg" alt="SmartCV Logo" width={96} height={96} className="hidden rotate-90 transition-all dark:block dark:rotate-0" />
                </Link>
